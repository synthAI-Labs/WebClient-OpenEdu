      ...
      <main className="flex min-h-screen flex-col items-center justify-between p-5 lg:p-12">
          ...
          <div className=" bottom-0 left-0 flex h-30 md:h-48 w-full items-end justify-center  lg:static lg:h-auto lg:w-auto lg:bg-none">
            <div className="flex flex-col text-center">
              ...
              <p className="text-2 font-medium m-2 text-slate-800 dark:text-slate-100">
                ...
                hands-on experiences to create something extraordinary from the
                ground up.
              </p>
            </div>
          </div>
        ...
        <div className="relative flex flex-col  place-items-center ">
          ...
          <p className="text-2xl md:text-3xl px-6 max-w-3xl text-center m-5 text-slate-800 dark:text-slate-100 font-thin">
            Our dedicated team is working tirelessly to bring ProjectX to life.
            Be the first to know when we launch by subscribing below. Get ready
            to dive into a world of creativity and innovation!
          </p>
        </div>
